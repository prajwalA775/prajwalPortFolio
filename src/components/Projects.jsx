...
const t = {
  ...
  database: 'APIs & DBs',
  subtitle: 'Showcasing My Creations',
  title: 'Featured Projects',
  aiMlLabel: 'Artificial Intelligence',
  fullStackLabel: 'Full-Stack Web',
  databaseLabel: 'Back-End & DB',
  detailsImpact: ' Details & Impact',
  overview: 'Overview',
  keyFeatures: 'Key Features',
  impactLearning: 'Impact & Learning',
  close: 'Close',
  ...
  const projects = [
    {
      ...
      category: ['ai-ml','full-stack','database','api'],
    ...
    },
    {
      ...
      category: ['full-stack'],
      github: 'https://github.com/prajwalA775/Civic-Fix.git',
      demo: '#',
      features: [
    ...
    },
    {
      ...
      github: 'https://github.com/prajwalA775/PassOP.git',
      demo: '#',
      features: [
    ...
    <section id="projects" className="section">
      <div className="container">
        ...
        <div
          ...
          className="projects-grid reveal-hidden"
          ref={reveal}
        >
          {filteredProjects.map((project) => (
            <div
              key={`${activeFilter}-${project.id}`}
              className="glass-card project-card-animate"
              style={{
                display: 'flex',
            ...
            >
              <div>
                ...
                >
                  {(Array.isArray(project.category) ? project.category.includes('ai-ml') : project.category === 'ai-ml') ? <Sparkles size={16} /> : <FolderCode size={16} />}
                  <span style={{ fontSize: '0.8rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    {(Array.isArray(project.category) ? project.category.includes('ai-ml') : project.category === 'ai-ml')
                      ? t.aiMlLabel
                      : (Array.isArray(project.category) ? project.category.includes('full-stack') : project.category === 'full-stack')
                        ? t.fullStackLabel
                        : t.databaseLabel}
                  </span>
                </div>
      ...
      {selectedProject && (
        ...
        >
          ...
          >
            ...
            <h4 style={{ fontSize: '1.05rem', color: '#fff', marginBottom: '0.5rem' }}>{t.overview}</h4>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
              {selectedProject.description}
            </p>

            <h4 style={{ fontSize: '1.05rem', color: '#fff', marginBottom: '0.5rem' }}>{t.keyFeatures}</h4>
            ...
            <h4 style={{ fontSize: '1.05rem', color: 'var(--color-accent)', marginBottom: '0.5rem' }}>{t.impactLearning}</h4>
      ...
      <style>{`
        ...
        .project-card-animate {
          animation: projectCardFadeIn 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
